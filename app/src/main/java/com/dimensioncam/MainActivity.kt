...
fun MainScreen() {
    ...
    var selectedPhotoId by remember { mutableLongStateOf(0L) }
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("photos") {
                val application = (navController.context as ComponentActivity).application as DimensionCamApplication
